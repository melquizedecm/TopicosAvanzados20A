...
<title>EDITAR REGISTROS DE EMPLEADOS</title>
...
<div class="signup-form">
    <form action="" method="post">
		<h2>Editar</h2>
		<p class="hint-text">Edita y Actualiza los datos de los Empleados.</p>
		
		<!--<p class="hint-text"><?php if(isset($datos[3])) {echo $datos[3]; } ?></p>-->
		<input type="hidden" name="id_empleados" value="<?php echo $datos[0]?>">
        ...
        <div class="form-group">
        	<input type="text" class="form-control" name="puesto" value="<?php echo $datos[4] ?>" placeholder="Puesto" required="required">
        </div>
        <div class="form-group">
        	<input type="text" class="form-control" name="edad" value="<?php echo $datos[5] ?>" placeholder="Edad" required="required">
        </div>
