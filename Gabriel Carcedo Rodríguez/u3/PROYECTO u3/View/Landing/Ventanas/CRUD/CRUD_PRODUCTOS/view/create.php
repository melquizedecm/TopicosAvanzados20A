...
<title>REGISTRAR NUEVOS PRODUCTOS</title>
...
<div class="signup-form">
    <form action="" method="post">
        ...
        <div class="form-group">
			<div class="row">
				<div class="col-xs-12"><input type="text" class="form-control" name="full_name_create" placeholder="Nombre del Producto" required="required"></div>
