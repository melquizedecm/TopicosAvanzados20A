   ...
   <button class="btn btn-outline-success my-2 my-sm-0" type="submit" href="Ventanas/Login.html">Iniciar sesión</button>
     ...
     <ul class="navbar-nav mr-auto">
      ...
      <!--ventana para iniciar sesión-->
         <li class="nav-item dropdown" >
        <a class="nav-link" href="../../Controller/Cerrar_Sesion.php" id="navbarDropdownMenuLink" role="button">Cerrar Sesión</a>
       ...
       <div class="container-footer-all">
            ...
            <div class="container-body">
                ...
                <div class="colum2">
                    ...
                    <div class="row">
                        <a href="https://www.facebook.com/AleMarentess/"><img src="icon/facebook.png"></a>
                        <label>Siguenos en Facebook</label>
                    </div>
                    <div class="row">
                        <a href="https://www.instagram.com/marentes_ale/?hl=es-la"><img src="icon/instagram.png"></a>
