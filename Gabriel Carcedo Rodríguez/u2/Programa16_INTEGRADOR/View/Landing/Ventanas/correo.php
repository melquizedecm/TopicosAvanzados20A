<!--
Sorce: correo.php
Description: Use of the librery for Send E-mail
Date: 19/Mar/2020
        ...
        <script>
          //INICIA LA CREACIÓN DEL CORREO
            ...
            const vue = new Vue({
                el: '#app',
                data(){
                  //OBTIENE LOS DATOS INGRESADOS PARA ENVIAR EL CORREO
                    return {
                        from_name: '',
                        to_email: '',
                        message: '',
                ...
                methods: {
                  //MÉTODO PARA ENVIAR
                    enviar(){
                        ...
                        //FUNCIONES PARA VALIDAR EL ENVÍO
