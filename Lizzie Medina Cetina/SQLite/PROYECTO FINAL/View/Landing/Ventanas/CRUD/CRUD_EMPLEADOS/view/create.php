...
<div class="signup-form">
    <form action="" method="post">
		<h2>Registrar</h2>
		<p class="hint-text">Añade un nuevo Vendedor.</p>
        ...
        <div class="form-group">
        	<input type="text" class="form-control" name="Ap_Materno" placeholder="Apellido Materno" required="required">
        </div>
	...
	<div class="text-center">Presiona aquí para ir a -><a href="index.php">VENDEDOR</a></div>
</div>
</body>
</html> 