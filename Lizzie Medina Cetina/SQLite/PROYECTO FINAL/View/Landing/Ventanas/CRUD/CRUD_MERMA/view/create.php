...
#Funciones:
# isset($mensaje) //función para determinar el mandato de un mensaje
******************************************************************************
*****************************************************************************/-->
...
<div class="signup-form">
    <form action="" method="post">
		...
		<h2>Registrar</h2>
		<p class="hint-text">Agrega rápidamente los productos mermados.</p>
        ...
        <div class="form-group">
        	<input type="text" class="form-control" name="trabajador" placeholder="Personal" required="required">
        </div>
