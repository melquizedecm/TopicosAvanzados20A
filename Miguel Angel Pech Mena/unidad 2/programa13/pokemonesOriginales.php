<!--/*******************************************************************************************
# Program Name: index.html y pokemonesOriginales.php
# Authors: Miguel Angel Pech Mena
# Description: Seleccion de pokemon mediante post y get
#
#Funciones:
# Liberias JS para el metodo post y get
#
********************************************************************************************//-->
<?php
...
echo '<br> <p> <b> <hr> <h1>'.$_POST['nombre'];
?>
