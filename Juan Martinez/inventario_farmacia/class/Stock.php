...
<?php
/*# Program Name: Stock.php
//# Authors: Miguel Pech Y Juan Martinez
//# Description: En este archivo podemos encontrar los metodos y funciones del CRUD de el inventario de la farmacia
//# El objetivo de este archivos es permitir modificarlos, visualizar
//, agregar y eliminar de la base de datos los datos almacenados.
*/
require_once('../database/Database.php');
require_once('../interface/iStock.php');
class Stock extends Database implements iStock {

//visualizar los campos del stock
...
//insertar datos al stock
	...
	{
		$sql = "SELECT s.stock_id,i.item_id,i.item_name, i.item_brand,SUM(stock_qty) as qty
				FROM stock s
				INNER JOIN item i
				ON s.item_id = i.item_id
				GROUP BY s.item_id
