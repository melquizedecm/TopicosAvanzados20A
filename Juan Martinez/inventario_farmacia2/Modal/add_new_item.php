		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="form-group">
					<label class="control-label col-sm-3" for="">Código de barra:</label>
					<div class="col-sm-9">
				  ...
				  <div class="form-group">
				    ...
				    <div class="col-sm-9">
				      <input type="number" min="0.1" max="1" step="any" class="form-control" id="item-price" placeholder="EL PRECIO DE LOS PRODUCTOS SE MANTIENE EN 1" required="">
				    </div>
				  </div>


				  <div class="form-group">
				    <label class="control-label col-sm-3" for="">Formula:</label>
				    <div class="col-sm-9">
				      <input type="text" maxlength="50" class="form-control" id="brand" placeholder="Ingrese la Formula" required="" autofocus="">
				    </div>
				  </div>

				  <div class="form-group">
				    <label class="control-label col-sm-3" for="">Cantidad de la Presentación</label>
				    <div class="col-sm-9">
				      <input type="text" class="form-control" id="grams" placeholder="Ingresa la cantidad en Mg o Ml" required="" autofocus="">
				    </div>
				  </div>
