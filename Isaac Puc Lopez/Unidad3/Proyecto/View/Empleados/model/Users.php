...
class Users{
	...
	function create($datos){
		$sql="INSERT INTO empleados (full_name, number_phone) VALUES ('".$datos[0]."', '".$datos[1]."')";
	...
	function update($datos){
		$sql="UPDATE empleados SET full_name='".$datos[1]."', number_phone='".$datos[2]."' WHERE id_empleado='".$datos[0]."' ";
		$respuesta=$this->link->query($sql);
		if (!$respuesta) {
			echo $this->link->error;
		}else{
