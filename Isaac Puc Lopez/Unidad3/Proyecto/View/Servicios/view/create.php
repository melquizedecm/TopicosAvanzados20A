...
<div class="signup-form">
    <form action="" method="post">
		...
		<h2>Registro</h2>
		<p class="hint-text">Crear servicio</p>
        ...
        <div class="form-group">
			<div class="row">
				...
				<div class="col-xs-12"><input type="text" class="form-control" name="full_name_create" placeholder="Nombre del servicio" required="required"></div>

			</div>        	
        </div>
        <div class="form-group">
        	<!--LE PONEMOS EL IDENTIFICADOR AL INPUT PARA HACER USO DE LA INFORMACION INGRESADA EN LAS FUNCIONES-->
        	<input type="phone" class="form-control" name="number_phone" placeholder="Precio del servicio en pesos MXN" required="required">
        </div>
