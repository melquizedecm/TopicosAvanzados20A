...
/*ANALIZA EL VALOR QUE SE LE HA MANDADO EN LA VISTA PRINCIPAL PARA SABER QUE FUNCION EJECUTARA SEGUN LA ACCION QUE SE HAYA PEDIDO*/
...
elseif(isset($_REQUEST[md5('id')])){
	/*SI EL ID ESTA ESTABLECIDO ENTONCES LA FUNCION QUE SE EJECUTA ES LA DE EDITAR*/
$datos=edit();
}
...
/*LA FUNCION CREATE CREA UN OBJETO DE LA CLASE USERS Y ESTABLECE LOS DATOS EN UN ARREGLO LOS CUALES ALMACENA LOS NUEVOS PARAMETROS A INGRESAR, LLAMA A LA FUNCION CREATE DE USERS Y MANDA ESE ARREGLO CON LOS DATOS ESTABLECIDOS, ESTE RECIBE LA RESPUESTA DE LA FUCNION Y MUESTRA UN MENSAJE EN PANTALLA*/
function create(){
$Users= new Users();
$datos=[];
...
/*LA FUNCION DELETE CREA UN OBJETO DE LA CLASE USERS, LLAMA A LA FUNCION DELETE DE ESA CLASE ENVIANDO COMO PARAMETRO EL ID ENCRIPTADO, ESTO DEVUELVE UNA RESPUESTA DE LA BASE DE DATOS, SEGUN LA REPSUESTA MOSTRARÁ UN MENSAJE EN PANTALLA*/
function delete(){
$Users=new Users();
