...
<div class="signup-form">
    <form action="" method="post">
		...
		<h2>Registro</h2>
		<p class="hint-text">Crear empleado</p>
        ...
        <div class="form-group">
        	<!--LE PONEMOS EL IDENTIFICADOR AL INPUT PARA HACER USO DE LA INFORMACION INGRESADA EN LAS FUNCIONES-->
        	<input type="phone" class="form-control" name="number_phone" placeholder="Numero Celular" required="required">
        </div>
